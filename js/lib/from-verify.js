	...
	function validateForm(selector){
		...
		var validation={
	        ...
	        messages:{
				...
				tel:{
					required:"<i class='fa fa-exclamation-circle'></i>请输入手机号码",
	            	isTel:"<i class='fa fa-exclamation-circle'></i>请输入正确的座机号码"
				},
	            username:{
				...
				houseChargArea:{
	            	required:"<i class='fa fa-exclamation-circle'></i>请填写计费面积",
	              	builtArea:"<i class='fa fa-exclamation-circle'></i>请输入正确的面积，小数点后最多两位"
	            },
				houseArea:{
	            	required:"<i class='fa fa-exclamation-circle'></i>请填写建筑面积",
	              	builtArea:"<i class='fa fa-exclamation-circle'></i>请输入正确的面积，小数点后最多两位"
	            },
				//messages结束
	    	},
	        ...
	        errorPlacement: function(error, element) {
        		error.appendTo(element.closest('.input-group').find('.msg') );
